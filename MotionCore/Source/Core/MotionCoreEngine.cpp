...
void MotionCore::MotionCoreEngine::Init(const MotionCore::MotionCoreEngineCreateInfo& _MotionCoreEngineCreateInfo)
{
    bodies = static_cast<MotionCore::RigidBody*>(MotionCore::MotionCoreAllocator::AllocateAlligned(_MotionCoreEngineCreateInfo.maxBodies * sizeof(MotionCore::RigidBody), alignof(MotionCore::RigidBody)));
}
...
MotionCore::MotionCoreEngine::~MotionCoreEngine()
{
    if (bodies != nullptr)
    {
        MotionCoreAllocator::Deallocate(bodies);
        bodies = nullptr;
    }
